...
var seo_check= module.exports = class seo_check {
        ...
        async loadHtmlContent(pathstr,readType){
            let fileobj = await htmlsource.gethtml(pathstr,readType);
        ...
        GenerateReport(saveType,savepath="",filename=""){

            if(saveType!=2 && savepath=="" && filename )
                throw new Error("need filepath & filename");
...
`;  
            ...
            return report.savelog(saveType,logReportStr,savepath,filename);
        }
